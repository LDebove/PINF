    ...
    <div class="rendez-vous">
        <div id=calendrier>
            <form name="sampleform">
                ...
                <input type="button"  value="Selectionner" id="but_calendrier" class="button"/>


                <input type="button"  value="Modifier" id="but_calendrier_modifier" class="button"/>
            </form>
        </div>

        <div class="calendrier-display">
            ...
            <div id="modifier_RDV">
                ...
                Heure du début du rendez-vous.<br>
                ...
                <br>
                Heure de fin du rendez-vous.<br>
